...
COLORS = ["#2563EB","#7C3AED","#DB2777","#16A34A","#EA580C","#0891B2","#CA8A04","#DC2626"]
...
def _L(title="", h=420):
    return dict(
        title=dict(text=f"<b>{title}</b>",font=dict(size=14,color="#0f172a",family="Inter"),x=0),
        font=dict(family="Inter,system-ui,sans-serif",size=11,color="#334155"),
        paper_bgcolor="rgba(0,0,0,0)",plot_bgcolor="#f8fafc",
        height=h,margin=dict(l=10,r=10,t=50,b=10),colorway=COLORS,
        hoverlabel=dict(bgcolor="white",bordercolor="#e2e8f0",font_family="Inter"),
    )
